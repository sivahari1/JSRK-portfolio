  ...
  return (
    <div className="pt-16">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-indigo-50 to-white dark:from-gray-900 dark:to-gray-800 px-2 sm:px-4">
        ...
        >
          <img src="@public/myphoto.jpg" alt="Dr. J. Siva Ramakrishna" className="mx-auto mb-6 w-32 h-32 sm:w-40 sm:h-40 rounded-full object-cover border-4 border-indigo-200 dark:border-indigo-600 shadow-lg" />
          <motion.h1 
